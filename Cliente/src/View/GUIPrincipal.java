...
public class GUIPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem3.setText("Listar Jugador");
        ...
        jMenuItem5.setText("Buscar Jugador");
        ...
        jMenuItem6.setText("Eliminar Jugador");
        ...
        jMenuItem7.setText("Actualizar Jugador");
    ...
    public static void main(String args[]) {
        String rmiRegistryHost = "192.168.15.2";
        try {
            if (args.length > 0) {
